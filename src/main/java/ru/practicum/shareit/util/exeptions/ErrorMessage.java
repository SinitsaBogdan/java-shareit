...
public enum ErrorMessage {
    ...
    REPOSITORY_ERROR__USER__ID_NOT_IN_REPO__ID("Ошибка формата запроса!", "Указанный id пользователя отсутствует в системе", 404),
    ...
    ITEM_ERROR__VALID__ITEM__USER_NOT_OWNER("Ошибка доступа!", "Пользователь не является владельцем записи", 403),
